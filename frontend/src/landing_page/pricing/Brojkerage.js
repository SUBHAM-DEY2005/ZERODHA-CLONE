...
function Brojkerage() {
    return ( <div className='container p-4'>
            <div className='row p-5'>
                <h1 className='fs-3 p-4'>Charges explained</h1>
                <div className='col-6 p-4 text-muted' style={{fontSize:"13px"}}>
                    ...
                    <p style={{fontSize:"17px"}}>Charges for Investor's Protection Fund Trust (IPFT) by NSE</p>
                    <ul>
                ...
                <div className='col-6 p-4 text-muted' style={{fontSize:"13px"}}>
                    ...
                    <p style={{fontSize:"17px"}}>DP (Depository participant) charges</p>
                    ...
                    <p style={{fontSize:"17px"}}>AMC (Account maintenance charges)</p>
                    <p>For BSDA demat account: Zero charges if the holding value is less than ₹4,00,000. To learn more about BSDA, <a href='/support' style={{textDecoration:"none"}}>Click here</a></p>
                    <p>For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly (90 days). To learn more about AMC, <a href='/support' style={{textDecoration:"none"}}>Click here</a></p>
                    ...
                    <p style={{fontSize:"17px"}}>Physical CMR request</p>
                    ...
                    <p>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. <a href='/support' style={{textDecoration:"none"}}>Learn more.</a></p>
                    <p style={{fontSize:"17px"}}>Trading using 3-in-1 account with block functionality
                    </p>
                    <ul>
                ...
                <div className='p-4 text-muted' style={{fontSize:"13px"}}>
                <p style={{fontSize:"17px"}}>Disclaimer</p>

            ...
            <div className='row'>
                ...
                <div className='col-6 p-5'>
                    ...
                    <div className='text-center'>
                        <a className='mx-5' style={{textDecoration: "none"}} href='/product'>Explore our products <i class="fa-solid fa-arrow-right-long"></i></a>
                        <a href='' style={{textDecoration: "none"}}>Try Kite demo <i class="fa-solid fa-arrow-right-long"></i> </a>
                    </div>
                </div>
            </div>
            <div className='text-center'>
                <img  style={{width:"60%"}} src='/media/images/pressLogos.png'/>
            </div>
        </div>
     );
}
